...
public class PdtListAction implements action.Action {
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		ArrayList<CataBigInfo> cataBigList = commonSvc.getCataBigList();			// 대분류 목록
		ArrayList<CataSmallInfo> cataSmallList = commonSvc.getCataSmallList();	// 소분류 목록
		ArrayList<BrandInfo> brandList = commonSvc.getBrandList();	// 소분류 목록
