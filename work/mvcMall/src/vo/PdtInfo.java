...
// 하나의 상품 정보를 저장할 클래스
	...
	public String getPl_orig() {
		return pl_orig;
	}
	public void setPl_orig(String pl_orig) {
		this.pl_orig = pl_orig;
	}
	...
	public String getPl_deli() {
		return pl_deli;
	}
	public void setPl_deli(String pl_deli) {
		this.pl_deli = pl_deli;
	}
	...
	public int getPl_salecnt() {
		return pl_salecnt;
	}
	public void setPl_salecnt(int pl_salecnt) {
		this.pl_salecnt = pl_salecnt;
	}
