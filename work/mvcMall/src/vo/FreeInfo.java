...
// 자유게시판 게시글 하나를 저장할 클래스
	...
	public int getFl_good() {
		return fl_good;
	}
	public void setFl_good(int fl_good) {
		this.fl_good = fl_good;
	}
	public int getFl_bad() {
		return fl_bad;
	}
	public void setFl_bad(int fl_bad) {
		this.fl_bad = fl_bad;
	}
	public String getFl_ismember() {
		return fl_ismember;
	}
	public void setFl_ismember(String fl_ismember) {
		this.fl_ismember = fl_ismember;
	}
	...
	public String getFl_pwd() {
		return fl_pwd;
	}
	public void setFl_pwd(String fl_pwd) {
		this.fl_pwd = fl_pwd;
	}
